# Geometric Abstraction Art Generator
...
- User input for # of Grid Line + Colored Squares, Color Scheme and Saturation.
	- User input fed to respective functions. Random module will be used alot.
- Animate workflow: Vertical Lines -> Horizontal Lines -> Colored Squares.
	- Using turtle libary to draw each part of the workflow.
...
- Week 2
  1. Create the Randomized Grid and Signiture Functions
  2. Create the Randomized Rectangle and Square Functions
